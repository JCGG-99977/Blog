<template>
  <div class="usermanager">
    ...
    >
      ...
      <el-table-column prop="time" label="注册日期" sortable width="180">
      </el-table-column>
      <el-table-column prop="user" label="用户名" sortable width="180">
      </el-table-column>
      <el-table-column prop="del_on" label="是否注销">
        <template slot-scope="scope">
    ...
    <el-drawer title="用户详情" :visible.sync="drawer">
